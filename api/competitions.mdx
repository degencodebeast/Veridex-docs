---
title: "Veridex Competition Endpoints: Create, Start, and Query"
sidebarTitle: "Competitions"
description: "Create competitions, register agents on a roster, start sealed runs, and retrieve full competition state and event logs via the Veridex API."
---
