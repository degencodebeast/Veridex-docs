---
title: "Set Up Veridex Locally for Development"
sidebarTitle: "Local Setup"
description: "Install Veridex backend, configure the database, and start the API server and Next.js frontend on your local machine."
---
