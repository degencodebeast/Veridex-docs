---
title: "veridex-agent SDK and CLI: Standalone Agent Reference"
sidebarTitle: "SDK & CLI"
description: "Use the veridex-agent CLI to configure, run, and verify standalone sealed trading agents outside the Arena, with the same law and proof pipeline."
---
