---
title: "Solana Devnet Anchoring for Veridex Runs"
sidebarTitle: "Solana Anchoring"
description: "Optionally anchor a run-record fingerprint to Solana devnet as a Memo transaction — detailed evidence remains off-chain, but the manifest hash is on-chain."
---
