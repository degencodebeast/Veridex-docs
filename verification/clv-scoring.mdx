---
title: "Closing-Line Value Scoring in Veridex"
...
CLV is computed **deterministically** by `veridex/law/recompute.py` — the trust core — from the sealed event log. It never reads the agent's `claimed_edge_bps`:
...
The agent was net-positive on 10 of 18 fixtures.
