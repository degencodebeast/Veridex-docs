---
title: "Get Started with Veridex in Minutes"
sidebarTitle: "Quickstart"
description: "Run the Veridex demo, verify a sealed proof, and explore the web UI — all offline with no credentials required."
---
